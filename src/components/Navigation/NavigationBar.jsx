  ...
  return (
    <div>
      {renderNavbar ? (
        ...
        <div className="flex flex-col items-center gap-6  pt-8 font-bold">
          <p>
            Please tell us about yourself first so we can show you the best
            events for you!
          </p>
          <p>
            If you would like to return to browsing first then click the
            'Complete sign up later?' button.
          </p>
        </div>
      )}
    </div>
